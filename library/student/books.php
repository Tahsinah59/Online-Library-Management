...
<body>
  ...
  <a href="issu_info.php">Issu Information</a>
</div>
...
<!-------requet book------------------>
		...
		<form class="navbar-form" method="post" name="form1">
			...
			<input class="form-control" style="width:300px"; type="text" name="book_id" placeholder="Enter Book ID that you want to request" required="">
	...
	if(isset($_POST['submit1'])){
		if(isset($_SESSION['login_user'])){
			mysqli_query($db,"INSERT INTO issu_book VALUES('$_SESSION[login_user]','$_POST[book_id]','','','')");
			?>
		...
		<?php
			...
			?>
			<script type="text/javascript">
				alert("You must to request a book first...");
			</script>
		<?php
		}
	}
